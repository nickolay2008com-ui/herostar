(() => {
  ...
  function init() {
    ...
    if (document.body.dataset.cloneCandyReady === 'true') return;
    document.body.dataset.cloneCandyReady = 'true';
    ...
    function enhanceMessage(message) {
      ...
      if (/сопоставляет ситуацию|размышляет|^я готов\.|^опишите реальную ситуацию/i.test(text)) return;
